...
/**
 * Mock appendable used for testing IOExceptions.
 */
...
public class MockAppendable implements Appendable {
   ...
   * {@code csq}, the entire sequence may not be appended.  For instance, if {@code csq} is a
   * {@link CharBuffer} then the subsequence to append is defined by the buffer's position and
   * limit.
   *
